...
import { Briefcase, Plus, Edit, Trash2, Save, X, DollarSign, Upload, Download, FileSpreadsheet, Search } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">{filteredServices.length} of {services.length} services</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent w-full sm:w-48"
              />
            </div>
            <button
